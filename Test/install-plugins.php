...
// (solo si la librería CSV del núcleo está disponible: el vendor del
// contenedor de desarrollo puede haberse regenerado sin ella, pero ahí
// la instalación ya está completa y no hace falta sanear nada)
